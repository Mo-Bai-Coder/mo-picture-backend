...
public class FileManager {
    ...
    public void validPicture(MultipartFile multipartFile) {
        ...
        ThrowUtils.throwIf(fileSize > 20 * ONE_M, ResCodeEnum.PARAMS_ERROR, "文件大小不能超过20M");
     ...
     * @throws BusinessException 当文件不符合要求时抛出业务异常
     */
    public void validPictureFileUrl(String fileUrl) {
        // 1. 校验非空
        ...
        try {
            ...
            if (StrUtil.isNotBlank(contentType)) {
                ...
                ThrowUtils.throwIf(!ALLOW_CONTENT_TYPES.contains(contentType.toLowerCase()),
                        ResCodeEnum.PARAMS_ERROR, "文件类型错误");
            }
            // 6. 文件存在，文件大小校验
            ...
            if (StrUtil.isNotBlank(contentLengthStr)) {
                try {
                    ...
                    ThrowUtils.throwIf(contentLength > 2 * ONE_M, ResCodeEnum.PARAMS_ERROR, "文件大小不能超过 2MB");
                } catch (NumberFormatException e) {
                    throw new BusinessException(ResCodeEnum.PARAMS_ERROR, "文件大小格式异常");
                }
            }
        } finally {
            // 记得释放资源
